...
```*/
    ...
    impl alloy_sol_types::SolInterface for TokenCalls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<TokenCalls>] = &[
                {
                    fn approve(data: &[u8]) -> alloy_sol_types::Result<TokenCalls> {
                        <approveCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(TokenCalls::approve)
                    }
                    approve
                },
                {
                    fn transferFrom(data: &[u8]) -> alloy_sol_types::Result<TokenCalls> {
                        <transferFromCall as alloy_sol_types::SolCall>::abi_decode_raw(
                                data,
                            )
                            .map(TokenCalls::transferFrom)
                    }
                    transferFrom
                },
                {
                ...
                {
                    fn allowance(data: &[u8]) -> alloy_sol_types::Result<TokenCalls> {
                        <allowanceCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(TokenCalls::allowance)
                    }
                    allowance
                },
            ];
    ...
    ///Container for all the [`Token`](self) events.
    #[derive(serde::Serialize, serde::Deserialize)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for TokenEvents {
        const NAME: &'static str = "TokenEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for TokenEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::Approval(inner) => {
...
See the [wrapper's documentation](`TokenInstance`) for more details.*/
    ...
    >(address: alloy_sol_types::private::Address, provider: P) -> TokenInstance<P, N> {
        TokenInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        TokenInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        TokenInstance::<P, N>::deploy_builder(provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<TokenInstance<P, N>> {
